...
EDH_tibble<- EDH_tibble %>% 
  mutate(dis_manibus_in_context_10w = str_extract(EDH_tibble$clean_text_interpretive_word_lowercase, "(\\w*\\s){1,6}\\bd m s\\b|\\bd m\\b|di{1,2}s manibus sacrum|di{1,2}s manibus(\\w*\\s){1,6}")) 
```
...
DM_map<- #head(EDH_DM, 100) %>% 
  ...
  colors = c("Blue", "Black", "Red", "Orange", "Yellow", "Green"),
  labels = c("dis manibus sacrum", "diis manibus sacrum", "dis manibus", "diis manibus", "d m s", "d m"), opacity = 1,
