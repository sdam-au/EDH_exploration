...
jsonlite::write_json(EDH_unnested_json, path="../data/EDH_people_clean_origo_2021-08-11.json")

sdam::request("../data/EDH_people_clean_origo_2021-08-11.json", path="/sharingout/648597@au.dk/SDAM_root/SDAM_data/EDH/public", force = TRUE,
...
population_age$age_cut <- cut(population_age$total_age, breaks = seq(0, 160, 5), right = FALSE) 
...
#labels
labels<- as.factor(c("0-4", "5-9", "10-14", "15-19", "20-24", "25-29", "30-34", "35-39", "40-44", "45-49", "50-54", "55-59", "60-64", "65-69", "70-74", "75-79", "80-84", "85-89", "90-94", "95-99", "100-104", "105-109", "110-114", "115-119", "120-124", "125-129", "130-134", "135-139", "140-144", "145-149", "150-154", "155-159","160-164", "165-169", "170-174", "175-179", "180-184", "185-189", "190-194", "195-199"))
labels_df <- as.data.frame(labels)

## for simplicity, add the age group labels we used in popGHcens above
#population_age$Age <- rep(unique(labels)[1:20], 2)
