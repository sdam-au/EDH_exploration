...
All records consist of the attributes: 
1) Eagle Linked Open Data numeric code for vocabulary, i.e. 257, extracted from the ref within XML tag. 
2) Free text description, extracted from the XML tag.
...
Data obtained only through API, probably die to an internal error in scripting. To be explored.
```{r}
EDH_tibble %>% 
...
## Object 
Attributes categorising the inscribed object.
...
## Inscription type
Attributes categorising the type of inscription.
...
## Material
Attributes categorising the inscribed material.
...
## Writing
Attributes categorising the execution of writing.
...
## Decoration 
Attributes categorising the type of decoration. In EDH very limited use - not the full potential of LOD.
