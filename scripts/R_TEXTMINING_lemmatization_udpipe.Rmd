...
#dl <- udpipe_download_model(language = "latin", model_dir = "../data/") # latin-perseus model
dl <- udpipe_download_model(language = "latin-proiel", model_dir = "../data/") # latin-proiel model

#dl <- udpipe_download_model(language = "latin-ittb", model_dir = "../data/") # latin-ittb model
...
#udmodel_latin <- udpipe_load_model(file = "../data/latin-perseus-ud-2.4-190531.udpipe")
udmodel_latin <- udpipe_load_model(file = "../data/latin-proiel-ud-2.4-190531.udpipe")
#udmodel_latin <- udpipe_load_model(file = "../data/latin-ittb-ud-2.4-190531.udpipe")
```
...
```{r}
#latin_perseus<- udpipe_text
#latin_proiel<- udpipe_text
#latin_ittb<- udpipe_text
```
...
# Saving subset to Sciencedata
```{r}
EDH_lemmatized_json <- jsonlite::toJSON(EDH_selection, auto_unbox = TRUE)
write(EDH_lemmatized_json, file="../data/EDH_text_lemmatized_2021-01-12.json")
request("../data/EDH_text_lemmatized_2021-01-12.json", path="/sharingout/648597@au.dk/SDAM_root/SDAM_data/EDH/public",
