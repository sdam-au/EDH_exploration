---
title: "Cleaning of the text of inscriptions"
...
```{r, echo = FALSE }
resp = request("EDH_merged_2020-09-17.json", path="/sharingin/648597@au.dk/SDAM_root/SDAM_data/EDH/", method="GET", cred=c(user, getPass("your sciencedata password: ")))
```
...
write(EDH_cleaned_json, file="EDH_cleaned_2020-09-17.json")
user <- readline("your sciencedata username: ")
