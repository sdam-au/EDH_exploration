...
## Display the Spanish subset of DM records
```{r, eval = false}
...
## Get nphawkes package from P Boyde
https://www.youtube.com/watch?v=lFhAQp8LHg4 
...
## Run MISD function on DIS MANIBUS dataset from Spain
...
# Are the spatial locations taken into account?
```



# Hawkes from Peter Halpin
```{r}
